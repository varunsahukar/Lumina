...
let ResearchController = class ResearchController {
    researchService;
    newsService;
    constructor(researchService, newsService) {
...
], ResearchController.prototype, "getArticles", null);
__decorate([
    (0, common_1.Get)('news'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ResearchController.prototype, "getNews", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ResearchController.prototype, "getArticle", null);
