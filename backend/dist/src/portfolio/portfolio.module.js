...
exports.PortfolioModule = PortfolioModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [portfolio_service_1.PortfolioService, rebalance_service_1.RebalanceService, reports_service_1.ReportsService],
        exports: [portfolio_service_1.PortfolioService, rebalance_service_1.RebalanceService, reports_service_1.ReportsService],
    })
], PortfolioModule);
